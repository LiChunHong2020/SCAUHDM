...
def convert_annotation(year, image_id, list_file):
    in_file = open('VOCdevkit/VOC%s/Annotations_test/%s.xml'%(year, image_id), encoding='utf-8')
...
for year, image_set in sets:
    ...
    for image_id in image_ids:
        list_file.write('%s/VOCdevkit/VOC%s/JPEGImages_test/%s.jpg'%(wd, year, image_id))
